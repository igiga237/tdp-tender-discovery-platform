...
export interface TenderNoticeInterface {
  ...
  'referenceNumber-numeroReference': string; // ADDED: Tender Reference ID
  'tenderStatus-appelOffresStatut-eng': string;
  'tenderClosingDate-appelOffresDateCloture': string; // ADDED: Closing Date
  'expectedContractStartDate-dateDebutContratPrevue': string; // ADDED: Contract Start Date
  'expectedContractEndDate-dateFinContratPrevue': string; // ADDED: Contract End Date
