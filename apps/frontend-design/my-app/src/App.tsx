...
function App() {
      ...
      .post("http://httpbin.org/post", fd, {
        onUploadProgress: (progressEvent) => {
          setProgress((prevState) => ({
            ...prevState,
            pc: progressEvent.progress ? progressEvent.progress * 100 : 0,
          }));
        },
        headers: {
          "Custom-header": "value",
  ...
  return (
    <div
      className="App"
      style={{ maxWidth: "400px", margin: "auto", textAlign: "center", padding: "20px", fontFamily: "Arial, sans-serif" }}
    >
      ...
      <div>
        ...
        <button
          ...
          style={{ padding: "10px 15px", backgroundColor: "grey", color: "white", border: "none", cursor: "pointer", borderRadius: "5px" }}
        >
          Upload
        </button>
      ...
      {progress.started && <progress max="100" value={progress.pc} style={{ width: "100%", marginBottom: "10px" }}></progress>}
